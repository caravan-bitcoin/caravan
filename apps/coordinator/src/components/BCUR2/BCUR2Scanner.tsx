...
interface BCUR2ScannerBaseProps {
  onStart?: () => void;
  onClear: () => void;
  startText?: string;
  width?: string | number;
...
interface BCUR2ScannerXPubProps extends BCUR2ScannerBaseProps {
  mode: "xpub";
  network: BitcoinNetwork;
  onSuccess: (data: ExtendedPublicKeyData) => void;
}

interface BCUR2ScannerPSBTProps extends BCUR2ScannerBaseProps {
  mode: "psbt";
  onSuccess: (psbt: string) => void;
  network?: BitcoinNetwork; // Optional for PSBT mode
}

type BCUR2ScannerProps = BCUR2ScannerXPubProps | BCUR2ScannerPSBTProps;
...
/**
 * Unified BCUR2 scanner component that handles both XPub and PSBT scanning.
 * Uses TypeScript discriminated unions for type safety based on mode.
 */
const BCUR2Scanner: React.FC<BCUR2ScannerProps> = (props) => {
