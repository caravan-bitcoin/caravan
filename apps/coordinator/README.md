...
- [Coldcard Mk2, Mk3, & Mk4](https://coldcard.com/)
  - **Security warning (July 2026):** Coinkite disclosed a firmware flaw reducing generated-seed entropy on Coldcard Mk2/Mk3 (firmware 4.0.1-4.1.9) and Mk4/Mk5/Q before their fixed firmware. Update to fixed firmware, generate a new seed and move funds - see the [Coinkite advisory](https://blog.coinkite.com/coldcard-mk3-seed-generation-warning/).
