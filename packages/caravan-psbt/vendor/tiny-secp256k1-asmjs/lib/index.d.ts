...
export declare function pointAdd(
  pA: Uint8Array,
  pB: Uint8Array,
  compressed?: boolean,
): Uint8Array | null;
export declare function pointAddScalar(
  p: Uint8Array,
  tweak: Uint8Array,
  compressed?: boolean,
): Uint8Array | null;
export declare function pointCompress(
  p: Uint8Array,
  compressed?: boolean,
): Uint8Array;
export declare function pointFromScalar(
  d: Uint8Array,
  compressed?: boolean,
): Uint8Array | null;
...
export declare function pointMultiply(
  p: Uint8Array,
  tweak: Uint8Array,
  compressed?: boolean,
): Uint8Array | null;
export declare function privateAdd(
  d: Uint8Array,
  tweak: Uint8Array,
): Uint8Array | null;
export declare function privateSub(
  d: Uint8Array,
  tweak: Uint8Array,
): Uint8Array | null;
...
export declare function xOnlyPointAddTweak(
  p: Uint8Array,
  tweak: Uint8Array,
...
export declare function signRecoverable(
  h: Uint8Array,
  d: Uint8Array,
  e?: Uint8Array,
): RecoverableSignature;
export declare function signSchnorr(
  h: Uint8Array,
  d: Uint8Array,
  e?: Uint8Array,
): Uint8Array;
