...
describe("BitBoxSignMessage", () => {
  ...
  // BIP-137 sig decoded to its 65-byte wire form — exactly what BitBox
  // returns as `electrumSig65`.
  ...
  it("run() base64-encodes electrumSig65 and returns SignMessageResult", async () => {
