  ...
  */
  ...
  /*
    ...
    Calculation : 
      ...
      Source : https://www.clearlypayments.com/blog/what-are-cross-um);border-fees-in-credit-card-payments/
  ...
  */
  ...
  /*
    ...
    Important Terms:
      ...
      - Scripy Type:
          The script type of the wallet. The change will always be of the same script type as the wallet.
      - Config:
