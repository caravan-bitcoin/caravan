...
var _Network$TESTNET, _Network$MAINNET, _RECEIVING_ADDRESSES, _Network$TESTNET2, _Network$MAINNET2, _CHANGE_ADDRESSES;
...
var RECEIVING_ADDRESSES = (_RECEIVING_ADDRESSES = {}, _defineProperty(_RECEIVING_ADDRESSES, _networks.Network.TESTNET, (_Network$TESTNET = {}, _defineProperty(_Network$TESTNET, _p2sh.P2SH, "2NE1LH35XT4YrdnEebk5oKMmRpGiYcUvpNR"), _defineProperty(_Network$TESTNET, _p2sh_p2wsh.P2SH_P2WSH, "2NE1LH35XT4YrdnEebk5oKMmRpGiYcUvpNR"), _defineProperty(_Network$TESTNET, _p2wsh.P2WSH, "tb1q9hj5j7mh9f7t6cwdvz34nj6pyzva5ftj2ecarcdqph5wc3n49hyqchh3cg"), _Network$TESTNET)), _defineProperty(_RECEIVING_ADDRESSES, _networks.Network.MAINNET, (_Network$MAINNET = {}, _defineProperty(_Network$MAINNET, _p2sh.P2SH, "3DRVz9YUhoXSMgBngvv2JkNReBHvkeJwLs"), _defineProperty(_Network$MAINNET, _p2sh_p2wsh.P2SH_P2WSH, "3DRVz9YUhoXSMgBngvv2JkNReBHvkeJwLs"), _defineProperty(_Network$MAINNET, _p2wsh.P2WSH, "bc1qxkl8fcuas3fv6mk79tk7d0nsug0909qcgvpjuj2asgltnafp46nsn4jnrh"), _Network$MAINNET)), _RECEIVING_ADDRESSES);
var CHANGE_ADDRESSES = (_CHANGE_ADDRESSES = {}, _defineProperty(_CHANGE_ADDRESSES, _networks.Network.TESTNET, (_Network$TESTNET2 = {}, _defineProperty(_Network$TESTNET2, _p2sh.P2SH, "2NB3tTnpcUanDenNhWbXxymTJhheWtj5Mu1"), _defineProperty(_Network$TESTNET2, _p2sh_p2wsh.P2SH_P2WSH, "2MyCBSwFWSXpagqKtrnckNtNQBnKdUZRhKc"), _defineProperty(_Network$TESTNET2, _p2wsh.P2WSH, "tb1qhjtyry0qwm5l6v5v7y27hc6m60vm0d8exlr3cswdrxsgaygqvd2q5zsl0n"), _Network$TESTNET2)), _defineProperty(_CHANGE_ADDRESSES, _networks.Network.MAINNET, (_Network$MAINNET2 = {}, _defineProperty(_Network$MAINNET2, _p2sh.P2SH, "36NMegVbRPbMv9RC4Ge2aKLUQHYXKbyooZ"), _defineProperty(_Network$MAINNET2, _p2sh_p2wsh.P2SH_P2WSH, "32M6VKsKw1X2EXFawpcHosMEhSxswLHRwX"), _defineProperty(_Network$MAINNET2, _p2wsh.P2WSH, "bc1qnzky4hcwcutvktfstp0u3kmtgxkjvscl25snvg45xu3ausv2lapqrvmkeh"), _Network$MAINNET2)), _CHANGE_ADDRESSES);
...
var BRAIDS = [{
  network: _networks.Network.TESTNET,
...
var MULTISIGS_BASE = [{
  ...
  transaction: {
    outputs: [{
      address: RECEIVING_ADDRESSES[_networks.Network.TESTNET][_p2sh.P2SH],
      amountSats: "291590",
      value: 291590
    }, {
      address: CHANGE_ADDRESSES[_networks.Network.TESTNET][_p2sh.P2SH],
      amountSats: "7535",
      value: 7535,
      bip32Derivation: [{
        masterFingerprint: Buffer.from("f57ec65d", "hex"),
  ...
  transaction: {
    outputs: [{
      address: RECEIVING_ADDRESSES[_networks.Network.TESTNET][_p2sh_p2wsh.P2SH_P2WSH],
      amountSats: "291590"
    }, {
      address: CHANGE_ADDRESSES[_networks.Network.TESTNET][_p2sh_p2wsh.P2SH_P2WSH],
      amountSats: "7922",
      value: 7922,
      bip32Derivation: [{
        masterFingerprint: Buffer.from("f57ec65d", "hex"),
  ...
  transaction: {
    outputs: [{
      address: RECEIVING_ADDRESSES[_networks.Network.TESTNET][_p2wsh.P2WSH],
      amountSats: "291590"
    }, {
      address: CHANGE_ADDRESSES[_networks.Network.TESTNET][_p2wsh.P2WSH],
      amountSats: "8023",
      value: 8023,
      bip32Derivation: [{
        masterFingerprint: Buffer.from("f57ec65d", "hex"),
  ...
  network: _networks.Network.MAINNET,
  type: _p2sh.P2SH,
  ...
  transaction: {
    outputs: [{
      address: RECEIVING_ADDRESSES[_networks.Network.MAINNET][_p2sh.P2SH],
      amountSats: "21590"
    }, {
      address: CHANGE_ADDRESSES[_networks.Network.MAINNET][_p2sh.P2SH],
      amountSats: "7535",
      value: 7535,
      bip32Derivation: [{
        masterFingerprint: Buffer.from("f57ec65d", "hex"),
  ...
  transaction: {
    outputs: [{
      address: RECEIVING_ADDRESSES[_networks.Network.MAINNET][_p2sh_p2wsh.P2SH_P2WSH],
      amountSats: "21590"
    }, {
      address: CHANGE_ADDRESSES[_networks.Network.MAINNET][_p2sh_p2wsh.P2SH_P2WSH],
      amountSats: "7922",
      value: 7922,
      bip32Derivation: [{
        masterFingerprint: Buffer.from("f57ec65d", "hex"),
  ...
  transaction: {
    outputs: [{
      address: RECEIVING_ADDRESSES[_networks.Network.MAINNET][_p2wsh.P2WSH],
      amountSats: "21590"
    }, {
      address: CHANGE_ADDRESSES[_networks.Network.MAINNET][_p2wsh.P2WSH],
      amountSats: "8023",
      value: 8023,
      bip32Derivation: [{
        masterFingerprint: Buffer.from("f57ec65d", "hex"),
...
var MULTISIGS = MULTISIGS_BASE.map(function (test) {
  ...
  braidAwareMultisig = _objectSpread(_objectSpread({}, multisig), {}, {
    braidDetails: (0, _braid.braidConfig)(test.braidDetails),
  ...
  return _objectSpread(_objectSpread({}, test), {
    ...
    utxos: test.utxos.map(function (utxo) {
      return _objectSpread(_objectSpread(_objectSpread({}, utxo), {
        amountSats: new _bignumber.default(utxo.amountSats).toString(),
        multisig: braidAwareMultisig,
        braidAwareMultisig: braidAwareMultisig
      }), {}, {
    ...
    transaction: _objectSpread(_objectSpread({}, test.transaction), {
      outputs: test.transaction.outputs.map(function (output) {
        return _objectSpread(_objectSpread({}, output), {
          amountSats: new _bignumber.default(output.amountSats).toString()
        });
      })
    }),
    multisig: braidAwareMultisig,
    braidAwareMultisig: braidAwareMultisig,
    multisigScript: test.type === _p2sh.P2SH ? (0, _multisig.multisigRedeemScript)(braidAwareMultisig) : (0, _multisig.multisigWitnessScript)(braidAwareMultisig),
